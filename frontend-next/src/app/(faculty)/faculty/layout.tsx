...
// Admin-only navigation, appended when the signed-in user is an admin. Both of
// these call routes gated on authorize('admin'), so showing them to faculty or
// an HOD only produces a 403 page.
